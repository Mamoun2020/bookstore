...
export const books: Book[] = [
  ...
  },
  {
    ...
    author: 'Prof. Mamoun Abu Salah',
    description: 'The Art of War is a book about the art of war. It is a book about the art of war.',
    price: 148.95,
    image: '/images/book4.jpg',
    isbn: '978-4678901234',
    genre: ['History', 'War'],
    tags: ['The Art of War', 'War', 'Strategy'],
    datePublished: '2023-08-20',
    pages: 100,
    language: 'English',
    publisher: 'Al-Kindi History Institute',
    rating: 4.8,
    reviewCount: 16,
    inStock: true,
    featured: true,
